...
import 'package:galmax/pages/chat_list/client_chooser_button.dart';
import 'package:galmax/utils/sync_status_localization.dart';
...
class ChatListHeader extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      ...
      snap: false,
      toolbarHeight: 64,
      // Как в Telegram: поиск всегда закреплён сверху, а не уплывает.
      // Раньше pinned был только в column-режиме (планшет), на телефоне
      // поиск уезжал и болтался посреди экрана.
      pinned: true,
      scrolledUnderElevation: 0,
      // Матовое стекло вместо transparent: контент под хедером блюрится
      // и текст не наезжает друг на друга при скролле.
