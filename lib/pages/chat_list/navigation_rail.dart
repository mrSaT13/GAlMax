...
import 'package:galmax/pages/chat_list/navi_rail_item.dart';
...
class SpacesNavigationRail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final coloredMode = !GalmaxThemes.isColumnMode(context);
      ...
      child: SafeArea(
        child: StreamBuilder(
          ...
          builder: (context, _) {
            ...
            return SizedBox(
              width: GalmaxThemes.isColumnMode(context)
                  ? GalmaxThemes.navRailWidth
                  : GalmaxThemes.navRailWidth - 8,
              child: Column(
                children: [
                  Expanded(
