...
import 'package:galmax/pages/chat/chat_app_bar_list_tile.dart';
import 'package:galmax/pages/chat/chat_app_bar_title.dart';
import 'package:galmax/pages/chat/chat_event_list.dart';
import 'package:galmax/pages/chat/live_location_chip.dart';
import 'package:galmax/pages/chat/pinned_events.dart';
import 'package:galmax/pages/chat/reply_display.dart';
...
class ChatView extends StatelessWidget {
  ...
  static void _showRecentContactsPanel(BuildContext context) {
    final client = Matrix.of(context).client;
    final recentRooms = client.rooms
        .where((r) => r.isDirectChat && r.lastEvent != null)
        .toList()
      ..sort((a, b) =>
          ...
          children: [
            ...
            Flexible(
              child: ListView.builder(
                shrinkWrap: true,
                itemCount: recentRooms.length.clamp(0, 10),
  ...
  Widget build(BuildContext context) {
    ...
    final bottomSheetPadding = GalmaxThemes.isColumnMode(context) ? 16.0 : 8.0;
        ...
        builder: (context, snapshot) => FutureBuilder(
          ...
          builder: (BuildContext context, snapshot) {
            ...
            return Scaffold(
              ...
              appBar: AppBar(
                shape: GalmaxThemes.isColumnMode(context)
                    ? Border(
                ...
                titleSpacing: GalmaxThemes.isColumnMode(context) ? 24 : 0,
                ...
                bottom: PreferredSize(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      LiveLocationChip(controller.room),
                      if (activeThreadId != null)
                        SizedBox(
                  ...
                  ? Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (controller.firstUnreadEventId != null ||
                          ...
                          // Переход к упоминанию меня.
                          if (controller.lastMentionEventId != null)
                            Padding(
                              padding: const EdgeInsets.only(bottom: 8),
                              child: FloatingActionButton.small(
                                onPressed: () => controller.scrollToEventId(
                                  controller.lastMentionEventId!,
                                ),
                                heroTag: null,
                                backgroundColor:
                                    theme.colorScheme.tertiaryContainer,
                        ...
                        GestureDetector(
                          ...
                          onHorizontalDragEnd: (details) {
                            if (details.primaryVelocity != null &&
                              ...
                              _showRecentContactsPanel(context);
                            }
                          },
