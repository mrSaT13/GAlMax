...
class _LockScreenState extends State<LockScreen> {
  ...
  void initState() {
    super.initState();
    // Сразу предлагаем биометрию, PIN — запасной вариант.
    WidgetsBinding.instance.addPostFrameCallback((_) => _tryBiometric());
  }

  Future<void> _tryBiometric() async {
    if (!mounted) return;
    if (!AppLock.of(context).biometricEnabled) return;
    final ok = await AppLock.of(context).unlockWithBiometrics();
    if (!ok && mounted) {
            ...
            child: ConstrainedBox(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (AppLock.of(context).biometricEnabled)
                    Padding(
