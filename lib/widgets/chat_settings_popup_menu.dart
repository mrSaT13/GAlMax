...
import 'package:galmax/pages/chat/chat_export.dart';
      ...
      children: [
        ...
        PopupMenuButton<ChatPopupMenuActions>(
          ...
          onSelected: (choice) async {
            switch (choice) {
              ...
              case ChatPopupMenuActions.encryption:
                ...
                break;
              case ChatPopupMenuActions.export:
                await exportChat(context, widget.room);
                break;
            }
          },
          itemBuilder: (BuildContext context) => [
            ...
            PopupMenuItem<ChatPopupMenuActions>(
              value: ChatPopupMenuActions.export,
              child: const Row(
                children: [
